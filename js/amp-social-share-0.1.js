...
(self.AMP = self.AMP || []).push({
    m: 0, v: "2502032353000", n: "amp-social-share", ev: "0.1", l: !0, f: function (t, e) {
        !function () {
            function e(t, e, a) {
            ...
            var c = Array.isArray, l = Object.prototype;

            function u(t, e) {
                void 0 === e && (e = t.hasAttribute("hidden")), e ? t.removeAttribute("hidden") : t.setAttribute("hidden", "")
            }
            ...
            function p(t) {
                return m.user || (m.user = d()), function (t, e) {
                    return e && e.ownerDocument.defaultView != t
                }(m.user.win, t) ? m.userForEmbed || (m.userForEmbed = d()) : m.user
            }
            ...
            function k(t, e) {
                var a, r, n = (a = y(t), (r = y(a)).isSingleDoc() ? r.win : r);
                return L(n, e) ? x(n, e) : null
            }

            function y(t) {
                return t.nodeType ? (a = t, e = (a.ownerDocument || a).defaultView, w(e, "ampdoc")).getAmpDoc(t) : t;
                var e, a
            }
            ...
            function x(t, e) {
                ...
                return a.obj || (g(a.ctor), g(a.context), a.obj = new a.ctor(a.context), g(a.obj), a.context = null, a.resolve && a.resolve(a.obj)), a.obj
            }
            ...
            var O = {
                ...
                "email": {
                    "bindings": ["recipient"],
                    "shareEndpoint": "#",
                    "defaultParams": {"subject": "TITLE", "body": "CANONICAL_URL", "recipient": ""}
                },
                "tumblr": {
                    "shareEndpoint": "#",
                ...
                "sms": {"shareEndpoint": "sms:", "defaultParams": {"body": "TITLE - CANONICAL_URL"}},
                "system": {
                    "shareEndpoint": "navigator-share:",
                    "defaultParams": {"text": "TITLE", "url": "CANONICAL_URL"}
                }
            }, C = "amp-social-share", E = function (t) {
                !function (t, e) {
                ...
                function y(t) {
                    var e;
                    return (e = d.call(this, t)).trt = null, e.Yt = {}, e.Ks = null, e.rrt = null, e.h = null, e.nrt = null, e
                }
                ...
                var x = y.prototype;
                return x.isLayoutSupported = function () {
                    return !0
                }, x.buildCallback = function () {
                    var t = this, e = this.element,
                        a = b(e.getAttribute("type"), "The type attribute is required. %s", e);
                    b(!/\s/.test(a), "Space characters are not allowed in type attribute value. %s", e), this.Ks = w(this.win, "platform");
                    var r = "share" in this.win.navigator;
                    if ("system" === a) {
                        if (!r) return void u(e, !1)
                    } else if (r && this.win.document.querySelectorAll("amp-social-share[type=system][data-mode=replace]").length) return void u(e, !1);
                    var n = O[a] || {};
                    if (n.obsolete) return u(e, !1), void p().warn(C, "Skipping obsolete share button ".concat(a));
                    this.trt = b(e.getAttribute("data-share-endpoint") || n.shareEndpoint, "The data-share-endpoint attribute is required. %s", e), Object.assign(this.Yt, n.defaultParams, function (t, e, a) {
                        var r = t.dataset, n = {}, i = /^param(.+)/;
                        for (var o in r) {
                            var s = o.match(i);
                            s && (n[s[1][0].toLowerCase() + s[1].substr(1)] = r[o])
                        }
                        return n
                    }(e)), this.nrt = n.bindings, e.setAttribute("role", "button"), e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"), e.getAttribute("aria-label") || e.setAttribute("aria-label", "Share by ".concat(a)), e.addEventListener("click", (function () {
                        return t.fo()
                    })), e.addEventListener("keydown", this.art.bind(this)), e.classList.add("amp-social-share-".concat(a))
                }, x.layoutCallback = function () {
                    var t = this;
                    if (!this.trt) return r || (r = Promise.resolve(void 0));
                    var e = function (t, e, a) {
                        if (!e) return t;
                        var r = t.split("#", 2), n = r[0].split("?", 2);
                        return n[0] + (n[1] ? "?".concat(n[1], "&").concat(e) : "?".concat(e)) + (r[1] ? "#".concat(r[1]) : "")
                    }(this.trt, function (t) {
                        var e, a, r, n = [];
                        for (var i in t) {
                            var o = t[i];
                            if (null != o) {
                                o = c(r = o) ? r : [r];
                                for (var s = 0; s < o.length; s++) n.push((e = i, a = o[s], "".concat(encodeURIComponent(e), "=").concat(encodeURIComponent(a))))
                            }
                        }
                        return n.join("&")
                    }(this.Yt)), a = k(this.element, "url-replace"), n = {};
                    return this.nrt && this.nrt.forEach((function (e) {
                        var a = e.toUpperCase();
                        n[a] = t.Yt[e]
                    })), a.expandUrlAsync(e, n).then((function (e) {
                        t.rrt = e;
                        var a, r = (a = t.element, k(a, "url")).parse(e).protocol, n = "mailto:" === r,
                            i = "sms:" === r;
                        t.h = t.Ks.isIos() && (n || i) ? "_top" : t.element.hasAttribute("data-target") ? t.element.getAttribute("data-target") : "_blank", i && (t.rrt = t.rrt.replace("?", "?&"))
                    }))
                }, x.art = function (t) {
                    var e = t.key;
                    ...
                    var t = this.rrt, r = this.h;
                    if ("navigator-share:" === this.trt) {
                        var n = this.win.navigator;
                        g(n.share);
                        var i = t.substr(t.indexOf("?")), o = function (t) {
                            var e, a = Object.create(null);
                            if (!t) return a;
                            for (; e = h.exec(t);) {
                                var r = f(e[1], e[1]), n = e[2] ? f(e[2].replace(/\+/g, " "), e[2]) : "";
                                a[r] = n
                            }
                            return a
                        }(i);
