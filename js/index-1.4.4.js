...
(() => {
            ...
            "undefined" != typeof self && self, e.exports = function (e) {
                ...
                var i = {
                    ...
                    avoidCookieUsage: function () {
                        ...
                        i.HORIZON_TRACK_HOST = "horizon-track.qa.globoi.com", i.HORIZON_SCHEMAS_HOST = "horizon-schemas.qa.globoi.com", i.HORIZON_REQUEST_ENCODING = "json"
                ...
                t.default = {
                    getContext: o, getResource: function (e, t) {
                        var n = o();
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.default = {
                    request: function (e, t, n, o) {
                        ...
                        r.open(e, t, !0), r.onload = function () {
                ...
                }(), r = l(n(4)), i = l(n(2)), a = l(n(1)), s = l(n(5)), c = l(n(0));
                ...
                var u = function () {
                    ...
                    }, d = ["GLBID", "GST", "EXT_ID"], f = "statusReady", h = "statusNotReady", g = "statusLoading",
                    p = "statusScheduled", b = "statusError", v = function () {
                        function e(t, n) {
                            !function (e, t) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this, e), this.state = n ? f : h, this.url = t, this.bypass = n, this.callbacks = {
                                onReady: [],
                                onError: [],
                                onRetry: [],
                                onLoad: []
                        ...
                        return o(e, [{
                            ...
                            key: "onReady", value: function (e) {
                                ...
                                if (this.callbacks.onReady.length > c.default.HORIZON_CALLBACK_STACK_LIMIT) throw new Error(a.default.LIMIT_EXCEEDED + " IDManager callback stack.");
                            ...
                            key: "retry", value: function () {
                                var e = this;
                                this.state = p, this.callbacks.onRetry.forEach((function (e) {
                                    return e()
                                })), setTimeout((function () {
                                    e.state = h, e.load()
                            ...
                            key: "setLoggedUser", value: function (e, t) {
                                ...
                                var n = u();
                                n.loggedIDs = Object.assign(n.loggedIDs || {}, function (e, t, n) {
                            ...
                            key: "setSessionID", value: function (e) {
                                e.hsid && (u().sessionIDs = Object.assign({}, {hsid: e.hsid}))
                            }
                        }, {
                            ...
                            key: "load", value: function () {
                                var e = this;
                                if (this.state === h) {
                                    this.state = g, this.callbacks.onLoad.forEach((function (e) {
                                        return e()
                                    }));
                                    var t = c.default.USE_HTTPS ? "https://" : "http://";
                                    s.default.request("GET", "" + t + this.url, (function (t) {
                                        e.setSessionID(t), e.setAnonymousUser(t, !1), e.state = f, e.callbacks.onReady.forEach((function (t) {
                        ...
                        var t = u();
                        if (!t.instance) {
                            var n = e || c.default.HORIZON_TRACK_HOST + "/" + c.default.HORIZON_TRACK_IDENTIFICATION_RESOURCE,
                ...
                t.default = {
                    getInstance: y, getContextManager: u, setLoggedUser: function (e, t) {
                        if (!c.default.AVOID_COOKIE_USAGE) throw Error(a.default.USE_MANAGER_ONLY_WHEN_AVOIDING_COOKIE);
                        e && 0 !== e.length || a.default.mustBeDefined("tokenName"), t && 0 !== t.length || a.default.mustBeDefined("tokenValue"), y().setLoggedUser(e, t)
                ...
                "use strict";
                Object.defineProperty(t, "__esModule", {value: !0}), t.IDManager = t.Settings = t.HorizonClient = void 0, n(8);
                var o = a(n(10)), r = a(n(0)), i = a(n(6));
                ...
                var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                    ...
                    }(), i = g(n(3)), a = g(n(0)), s = g(n(13)), c = g(n(1)), l = g(n(15)), u = g(n(26)), d = g(n(27)),
                    f = g(n(6)), h = g(n(2));
                ...
                var p = "stateReady", b = "stateNotReady", v = "stateLoading", y = ["web", "instant-article", "app"],
                    m = function () {
                        function e() {
                            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                                n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, o = this,
                                r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                                g = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "web";
                            if (function (e, t) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this, e), this.tenant = t || d.default.getTenant() || c.default.mustBeDefined("tenant"), this.deviceGroup = n || d.default.getDeviceGroup() || c.default.mustBeDefined("deviceGroup"), this.defaultContentType = r, -1 === y.indexOf(g)) throw Error(c.default.INVALID_ENVIRONMENT);
                            this.environment = g, this.validator = s.default, this.clientVersion = a.default.PACKAGE_VERSION, this.state = b, this.referer = document.referrer;
                            var p = null, v = null, m = null, I = function () {
                            ...
                            this.getHorizonActionSequence = function () {
                                ...
                                if (!v) {
                                    var e = l.default.getInstance(o.tenant, o.deviceGroup, o.environment, o.getIdManager());
                                    o.setEventBus(e)
                                }
                                return v
                        ...
                        return r(e, [{
                            ...
                            key: "onReady", value: function (e) {
                                this.validator.isReady() ? this.getSchemasProvider().isReady() ? this.getIdManager().isReady() ? (this.state = p, e()) : (this.state = v, this.getIdManager().onReady(e), this.getIdManager().load()) : (this.state = v, this.getSchemasProvider().onReady(e), this.getSchemasProvider().load()) : (this.state = v, this.validator.onReady(e), this.validator.load())
                            }
                        }, {
                            ...
                            key: "send", value: function (e) {
                                ...
                                if (null != n && "string" != typeof n) throw new Error(c.default.INVALID_RELATION_ID + " Wrong relationId type. It should be a String: actual type is " + (void 0 === n ? "undefined" : o(n)));
                            ...
                            key: "sendWithInfo", value: function (e, t) {
                                var n = this;
                                if (!this.isReady()) return this.state === b && this.flush(), void this.onReady((function () {
                                    return n.sendWithInfo(e, t)
                                }));
                                this.validateBeforeEnqueue(e);
                                var o = Object.assign({}, t, e);
                                o.contentType || (this.defaultContentType || c.default.mustBeDefined("contentType"), o.contentType = this.defaultContentType), this.getEventBus().enqueue(o)
                            }
                        }, {
                ...
                var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                    ...
                    return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
                }, r = s(n(14)), i = s(n(1)), a = s(n(0));

                function s(e) {
                    return e && e.__esModule ? e : {default: e}
                }

                var c = {ready: []}, l = ["url"], u = function () {
                    return !!window.tv4
                }, d = function (e) {
                    return null === e || isNaN(e) && !isNaN(Date.parse(e)) ? null : i.default.INVALID_DATE
                }, f = function (e) {
                    return "string" != typeof e ? i.default.INVALID_STRING_NUMERIC_STRING : "" === e.trim() ? i.default.INVALID_EMPTY_NUMERIC_STRING : Number.isFinite(Number(e)) ? null : i.default.INVALID_NUMERIC_STRING
                };
                t.default = {
                    validateFor: function (e, t) {
                        if (!u()) throw new Error(i.default.ERROR_LOADING_RESOURCE + " Validator is not ready.");
                        ...
                        })).length > 0) throw new Error(i.default.INVALID_FORMAT + " Wrong object type: " + JSON.stringify(e));
                    ...
                    }, tv4IsValidData: d, tv4IsNumericString: f, isReady: u, onReady: function (e) {
                        if (u()) return e();
                        if (c.ready.length > a.default.HORIZON_CALLBACK_STACK_LIMIT) throw new Error(i.default.LIMIT_EXCEEDED + " Validator callback stack.");
                        ...
                        if (!r.default.isDefined("tv4")) {
                            ...
                            (0, r.default)([e], "tv4", {
                                ...
                                success: function () {
                                    tv4.addFormat("date-time", d), tv4.addFormat("numericString", f), c.ready.forEach((function (e) {
                                        return e()
                                    }))
                                },
                                error: function (e) {
                ...
                a = function () {
                    ...
                    function a(t, n, o, r) {
                        var i, s, c = document, l = o.async, u = (o.numRetries || 0) + 1, d = o.before || e,
                            f = t.replace(/^(css|img)!/, "");
                        r = r || 0, /(^css!|\.css$)/.test(t) ? ((s = c.createElement("link")).rel = "stylesheet", s.href = f, (i = "hideFocus" in s) && s.relList && (i = 0, s.rel = "preload", s.as = "style")) : /(^img!|\.(png|gif|jpg|svg)$)/.test(t) ? (s = c.createElement("img")).src = f : ((s = c.createElement("script")).src = t, s.async = void 0 === l || l), s.onload = s.onerror = s.onbeforeload = function (e) {
                            var c = e.type[0];
                            if (i) try {
                    ...
                    function s(e, n, o) {
                        ...
                        function l(t, n) {
                            !function (e, t, n) {
                                var o, r, i = (e = e.push ? e : [e]).length, s = i, c = [];
                                for (o = function (e, n, o) {
                                    if ("e" == n && c.push(e), "b" == n) {
                                        if (!o) return;
                                        c.push(e)
                                    }
                    ...
                    return s.ready = function (e, t) {
                        return function (e, t) {
                            var r, i, a, s = [], c = (e = e.push ? e : [e]).length, l = c;
                            for (r = function (e, n) {
                                n.length && s.push(e), --l || t(s)
                            }; c--;) i = e[c], (a = n[i]) ? r(i, a) : (o[i] = o[i] || []).push(r)
                        }(e, (function (e) {
                            i(t, e)
                        })), s
                    }, s.done = function (e) {
                ...
                }, r = [], void 0 === (i = "function" == typeof (o = a) ? o.apply(t, r) : o) || (e.exports = i)
            }, function (e, t, n) {
                "use strict";
                Object.defineProperty(t, "__esModule", {value: !0});
                var o = function () {
                ...
                n(16);
                var r = d(n(2)), i = d(n(17)), a = d(n(0)), s = d(n(1)), c = d(n(22)), l = d(n(24)), u = d(n(25));
                    ...
                    return o(e, [{
                        ...
                        key: "sendByFetch", value: function (e, t) {
                            try {
                                return fetch(e, {method: "POST", credentials: "include", body: t}).then((function (e) {
                                    e.ok || console.error("Failed to send Horizon events using fetch. Status " + e.status + " - " + e.statusText)
                                })), !0
                            } catch (e) {
                                return !1
                            }
                        ...
                        key: "sendByXMLHttpRequest", value: function (e, t, n) {
                            try {
                                ...
                                return o.open("POST", e), o.withCredentials = !0, "json" === n && o.setRequestHeader("Content-Type", "application/json"), o.onreadystatechange = function () {
                                    if (o.readyState === XMLHttpRequest.DONE) {
                                        var e = o.status, t = o.statusText;
                                        0 === e || e >= 200 && e < 400 || console.error("Failed to send Horizon events using XMLHttpRequest. Status " + e + " - " + t)
                                    }
                                }, o.send(t), !0
                            } catch (e) {
                                return !1
                        ...
                        key: "dispatch", value: function (e) {
                            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "json",
                                n = a.default.USE_HTTPS ? "https://" : "http://", o = this.idManager.getAsKeyValue(),
                                r = o ? "?" + o : "",
                                s = "" + n + c.default.applyDestinationPolicy() + "/event/" + this.currentTenant + r,
                                l = i.default.get(t);
                            if (!this.isValidRequest(e)) return !1;
                            this.dispatchNumber += 1;
                            var u = l(e), d = !1, f = !1, h = !1;
                            try {
                                d = navigator.sendBeacon(s, u)
                            } catch (e) {
                                d = !1
                            }
                            return d || (h = this.sendByFetch(s, u)) || (f = this.sendByXMLHttpRequest(s, u, t)), d || h || f
                        }
                    }, {
                ...
                (function () {
                    ...
                    }).call(this) || ("navigator" in this || (this.navigator = {}), this.navigator.sendBeacon = function (e, t) {
                        var n = this.event && this.event.type, o = "unload" === n || "beforeunload" === n,
                            r = "XMLHttpRequest" in this ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
                        r.open("POST", e, !o), r.withCredentials = !0, r.setRequestHeader("Accept", "*/*"), function (e) {
                            return "string" == typeof e
                        }(t) ? (r.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"), r.responseType = "text/plain") : function (e) {
                            return e instanceof Blob
                        }(t) && t.type && r.setRequestHeader("Content-Type", t.type);
                        try {
                            r.send(t)
                        } catch (e) {
                            return !1
                ...
                (function (e, o) {
                    ...
                    !function (i) {
                        ...
                        var c = function (e) {
                                throw new s(e)
                            }, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", u = /[\t\n\f\r ]/g,
                            d = {
                                encode: function (e) {
                                    e = String(e), /[^\0-\xFF]/.test(e) && c("The string to be encoded contains characters outside of the Latin1 range.");
                                    for (var t, n, o, r, i = e.length % 3, a = "", s = -1, u = e.length - i; ++s < u;) t = e.charCodeAt(s) << 16, n = e.charCodeAt(++s) << 8, o = e.charCodeAt(++s), a += l.charAt((r = t + n + o) >> 18 & 63) + l.charAt(r >> 12 & 63) + l.charAt(r >> 6 & 63) + l.charAt(63 & r);
                                    return 2 == i ? (t = e.charCodeAt(s) << 8, n = e.charCodeAt(++s), a += l.charAt((r = t + n) >> 10) + l.charAt(r >> 4 & 63) + l.charAt(r << 2 & 63) + "=") : 1 == i && (r = e.charCodeAt(s), a += l.charAt(r >> 2) + l.charAt(r << 4 & 63) + "=="), a
                                }, decode: function (e) {
                                    ...
                                    for (var n, o, r = 0, i = "", a = -1; ++a < t;) o = l.indexOf(e.charAt(a)), n = r % 4 ? 64 * n + o : o, r++ % 4 && (i += String.fromCharCode(255 & n >> (-2 * r & 6)));
                                    return i
                                }, version: "0.1.0"
                            };
                        void 0 === (r = function () {
                ...
                !function (e) {
                    var t, n, o, r = String.fromCharCode;
                    ...
                    function c(e) {
                        ...
                        var t = "";
                        return 0 == (4294965248 & e) ? t = r(e >> 6 & 31 | 192) : 0 == (4294901760 & e) ? (a(e), t = r(e >> 12 & 15 | 224), t += s(e, 6)) : 0 == (4292870144 & e) && (t = r(e >> 18 & 7 | 240), t += s(e, 12), t += s(e, 6)), t + r(63 & e | 128)
                    }
                    ...
                    function u() {
                        ...
                        if (224 == (240 & e)) {
                            if ((r = (15 & e) << 12 | l() << 6 | l()) >= 2048) return a(r), r;
                            throw Error("Invalid continuation byte")
                        }
                        if (240 == (248 & e) && (r = (7 & e) << 18 | l() << 12 | l() << 6 | l()) >= 65536 && r <= 1114111) return r;
                        throw Error("Invalid UTF-8 detected")
                    }

                    e.version = "3.0.0", e.encode = function (e) {
                        for (var t = i(e), n = t.length, o = -1, r = ""; ++o < n;) r += c(t[o]);
                        return r
                    }, e.decode = function (e) {
                ...
                t.default = {
                    applyThrottlingPolicy: function (e) {
                        var t = r.default.EVENTS_SENDER_MIN_INTERVAL, n = r.default.EVENTS_SENDER_MAX_INTERVAL,
                        ...
                        function o(t, r, i) {
                            ...
                            if ("undefined" != typeof document) {
                                ...
                                for (var u = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, f = 0; f < u.length; f++) {
                                    var h = u[f].split("="), g = h.slice(1).join("=");
                                    this.json || '"' !== g.charAt(0) || (g = g.slice(1, -1));
                                    try {
                                        var p = h[0].replace(d, decodeURIComponent);
                                        if (g = n.read ? n.read(g, p) : n(g, p) || g.replace(d, decodeURIComponent), this.json) try {
                                            g = JSON.parse(g)
                                        } catch (e) {
                                        }
                                        if (t === p) {
                ...
                }(), r = l(n(4)), i = l(n(2)), a = l(n(1)), s = l(n(0)), c = l(n(5));

                function l(e) {
                    return e && e.__esModule ? e : {default: e}
                }

                var u = "statusReady", d = "statusNotReady", f = "statusLoading", h = "statusScheduled",
                    g = "statusError", p = function () {
                        return i.default.getResource("schemas", {data: {}})
                    }, b = function () {
                        function e(t) {
                            !function (e, t) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this, e), this.url = t, this.state = d, this.callbacks = {
                                onReady: [],
                                onError: [],
                                onRetry: [],
                                onLoad: []
                        ...
                        return o(e, [{
                            ...
                            key: "retry", value: function () {
                                var e = this;
                                this.state = h, this.callbacks.onRetry.forEach((function (e) {
                                    return e()
                                })), setTimeout((function () {
                                    e.state = d, e.load()
                ...
                t.default = {
                    getInstance: function (e) {
                        var t = p();
                        return t.provider || (t.provider = new b(e || s.default.HORIZON_SCHEMAS_HOST + "/schemas")), t.provider
                    }, getContextSchemas: p
                }
            }, function (e, t, n) {
                "use strict";
    ...
    (() => {
        ...
        class e {
            constructor() {
                var e;
                this.settings = null === (e = window.cdaaas) || void 0 === e ? void 0 : e.SETTINGS
            }
            ...
            get(e) {
                ...
                try {
                    ...
                    return console.warn(`[PORTFÓLIO][BARRA] A propriedade "${t}" não foi encontrada nas configurações globais`), null
                }
            }
        }
        ...
        function i(e, t) {
            const n = e.shadowRoot.querySelector(".button-login"), o = n.querySelector(".button-login-name");
            n.ariaLabel = "Login", o.innerHTML = "Conta Globo", t && a(e.shadowRoot, t)
        }

        function a(e, t) {
            const n = e.querySelector(".button-login-icon"), o = e.querySelector(".button-login-img");
            if (t.icon.startsWith("http")) return o.src = t.icon, void (o.style.display = "inherit");
            if (n.innerHTML = t.icon, 1 === t.icon.length) {
                const e = function (e) {
                    const t = ["#E40D39", "#FD7D23", "#15984A", "#FDBD36", "#199ED8", "#073DA3", "#9A3296", "#E3289A"],
                        n = null == e ? void 0 : e.toUpperCase();
                    return ["A"].includes(n) ? t[0] : ["B", "C", "D", "E"].includes(n) ? t[1] : ["F", "G", "H", "I"].includes(n) ? t[2] : ["J", "K", "L"].includes(n) ? t[3] : ["M", "N", "O"].includes(n) ? t[4] : ["P", "Q", "R"].includes(n) ? t[5] : ["S", "T", "U", "V"].includes(n) ? t[6] : ["W", "X", "Y", "Z"].includes(n) ? t[7] : null
                }(t.icon);
                n.style.marginRight = "var(--spacing-50)", e ? (n.style.backgroundColor = e, n.style.color = "#fff") : n.style.backgroundColor = "#f5f5f5"
            }
        }
        ...
        class s {
            ...
            createElement() {
                ...
                if (c.innerHTML = this.props.name, this.props.url && (c.href = this.props.url), this.props.onClick && c.addEventListener("click", this.props.onClick), (null === (t = null === (e = this.props) || void 0 === e ? void 0 : e.logo) || void 0 === t ? void 0 : t.useImage) && this.props.logo.image) {
                    c.innerHTML = this.props.logo.image;
                    const e = c.querySelector("svg");
                    (null === (r = null === (n = this.props.logo) || void 0 === n ? void 0 : n.customStyle) || void 0 === r ? void 0 : r.height) && (e.style.height = null === (a = null === (i = this.props.logo) || void 0 === i ? void 0 : i.customStyle) || void 0 === a ? void 0 : a.height)
                }
                return o(c, null === (s = this.props) || void 0 === s ? void 0 : s.attributes), c
            }
        }
        ...
        class c {
            ...
            createElement() {
                ...
                return o(t, null === (e = this.props) || void 0 === e ? void 0 : e.attributes), t
            }
        }
        ...
        class l {
            ...
            createElement() {
                ...
                return this.props.onClick && n.addEventListener("click", this.props.onClick), o(n, this.props.attributes), (null === (t = null === (e = this.props.attributes) || void 0 === e ? void 0 : e.class) || void 0 === t ? void 0 : t.includes("button-login")) ? (n.insertAdjacentElement("afterbegin", this.createSpan()), n.insertAdjacentElement("afterbegin", this.createIcon())) : n.innerHTML = this.props.icon ? this.props.icon + this.props.name : this.props.name, n
            }

            createSpan() {
                const e = document.createElement("span");
                return e.classList.add("button-login-name"), e.innerHTML = this.props.name, e
            }

            createIcon() {
                const e = document.createElement("div");
                return e.classList.add("button-login-icon"), this.props.icon.startsWith("http") || (e.innerHTML = this.props.icon), e.insertAdjacentElement("afterbegin", this.createImage()), e
            }

            createImage() {
                const e = document.createElement("img");
                return e.classList.add("button-login-img"), e.alt = "Perfil do usuário", e.style.display = "none", e
            }
        }
        ...
        const u = {
            qa: {
                env: "qa",
                auth_server_url: "https://goidc.authentication.qa.globoi.com/auth/realms/globo.com/protocol/openid-connect/auth",
                client_globoid_url: "https://s3.glbimg.com/v1/AUTH_05f06ca986b54d6e9c5df94927ccf7fc/libs/globoid-js/1.3.1/globoid-js.min.js",
                oidcProvider: "https://goidc.authentication.qa.globoi.com/auth/realms/globo.com",
            ...
            prod: {
                env: "prod",
                auth_server_url: "https://goidc.globo.com/auth/realms/globo.com/protocol/openid-connect/auth",
                client_globoid_url: "https://s3.glbimg.com/v1/AUTH_05f06ca986b54d6e9c5df94927ccf7fc/libs/globoid-js/1.3.1/globoid-js.min.js",
        ...
        class f {
            static executeGloboIdSetup(e, t) {
                var n = f.glb.barra.defaults.oidcSettings, o = n.clientId;
                f.glb.globoIdClientMap.initNewGloboIdClient(n).then((function () {
            ...
            static enqueueApplicationUsage(e) {
                ...
                return t.stageQueueMap.applicationUsageStageQueue = t.stageQueueMap.applicationUsageStageQueue || [], new Promise((function (e, n) {
            ...
            static prepareGloboIdExecution() {
                ...
                return new Promise((function (t, n) {
                    f.domainSetup(e).then((function (o) {
                        o ? f.enqueueApplicationUsage(e).then((function (e) {
                            t(e)
                        })) : n("[PORTFÓLIO][BARRA] GloboId client was not initialized correctly")
                    })).catch((function (e) {
                        n(e)
                    }))
                }))
            ...
            static login() {
                f.prepareGloboIdExecution().then((function (e) {
            ...
            static isLogged() {
                return new Promise((function (e, t) {
                    f.prepareGloboIdExecution().then((function (t) {
                        e(t.isLogged())
                    })).catch((function (e) {
                        console.error("[PORTFÓLIO][BARRA] isLogged not executed. ".concat(e)), t(e)
                    }))
                }))
            }
            ...
            static getUserData() {
                return new Promise((function (e, t) {
                    f.prepareGloboIdExecution().then((function (t) {
                        ...
                        console.error("[PORTFÓLIO][BARRA] loadUserInfo not executed. ".concat(e)), t(e)
                    }))
                }))
            }
            ...
            static getGloboIDInfo(e) {
                return d(this, void 0, void 0, (function* () {
                    ...
                    var n = window.glb, o = {
                        defaults: {
                            oidcSettings: {
                                redirectUri: window.location.origin.concat("/" + u[t].show_redirect_path),
                                ...
                                return d(this, void 0, void 0, (function* () {
                                    return window.globalWebdeps ? yield window.globalWebdeps("globoid-js") : n.barra.clientGloboId.loadClientGloboId()
                                }))
                            }
                        }
                    };
                    window.glb.barra ? window.glb.barra = Object.assign(window.glb.barra, o) : window.glb.barra = o, f.glb = window.glb || {};
                    try {
                        yield window.glb.barra.defaults.resolveGloboIdJs();
                        const t = yield f.getUserState();
                        e.updateButton(t), console.log("[PORTFÓLIO][BARRA] globoid-js carregado com sucesso: ")
                    } catch (t) {
                        e.updateButton(null), console.error("[PORTFÓLIO][BARRA] Erro ao carregar globoid-js")
                    }
                }))
            }
        ...
        f.glb = window.glb || {};
        const h = {scroll: {currentScrollLeft: 0, hasMovedLeft: !1, hasMovedRight: !1}};

        class g {
            constructor(e) {
                this.props = e, this.handleScrollHorizontal = e => {
                    const t = e.target, n = this.calcWidthOverlayScroll(t);
                    t.style.setProperty("--overlay-width", `${n.toFixed(1)}px`), this.state.scroll.hasMovedLeft && this.state.scroll.hasMovedRight || (this.hasMovedLeft(this.state.scroll.currentScrollLeft, t) ? this.onScrollLeft(t) : this.onScrollRight(t))
                }, this.calcWidthOverlayScroll = e => {
                    const t = e.scrollWidth - e.offsetWidth;
                    return 80 * (1 - e.scrollLeft / t)
                }, this.hasMovedLeft = (e, t) => e > t.scrollLeft, this.onScrollLeft = e => {
                    this.state.scroll.hasMovedLeft || (C.getInstance().send("barra globo", "Swipe", "left"), R.getInstance().event("barra globo", "left", !0, "Swipe")), this.state = Object.assign(Object.assign({}, this.state), {
                    ...
                    this.state.scroll.hasMovedRight || (C.getInstance().send("barra globo", "Swipe", "right"), R.getInstance().event("barra globo", "right", !0, "Swipe")), this.state = Object.assign(Object.assign({}, this.state), {
                        scroll: Object.assign(Object.assign({}, this.state.scroll), {
                            currentScrollLeft: e.scrollLeft,
                            hasMovedRight: !0
                        })
            ...
            createElement() {
                const e = document.createElement("div"), t = this.createContainerList();
            ...
            createListItemsProduct() {
                return [...this.props.barraConfig.defaultProducts, ...this.props.barraConfig.additionalProducts].map((e => this.createListItemProduct({
                    productConfig: e,
            ...
            createContainerList() {
                ...
                if (!r() && this.props.barraConfig.additionalProducts.length > 0) {
            ...
            createContainerRight() {
                ...
                if (this.props.barraConfig.login.showButton) {
                    const t = this.createButtonLogin({name: "Conta Globo", root: this.props.root});
                    e.appendChild(t)
                }
        ...
        class p {
            constructor(e) {
                this.props = e, this.handleClick = e => {
                    C.getInstance().send("barra globo", "Click Link Produto", this.props.url), R.getInstance().event("barra globo - Link produto", this.props.url, !0, "click")
                }
            }
            ...
            createElement() {
                ...
                var t, n;
                return t = e, (n = {"--link-logo-hover-border-color": this.props.customStyle.color}) && Object.keys(n).forEach((e => {
            ...
            createLink() {
                ...
                return new s({
                    ...
                    logo: {
                        ...
                        customStyle: null === (e = this.props.logo) || void 0 === e ? void 0 : e.customStyle
                    },
                    attributes: {
                        class: "link-logo",
                        tabIndex: t ? -1 : 0,
            ...
            isCurrentUrl(e) {
                ...
                return e.replace(t, "").replaceAll("/", "") === n.replace(t, "").replaceAll("/", "")
            }
        }
        ...
        class v {
            ...
            formatJsonUrl(e) {
                return "https://novabarra.globo.com/products-config/[tenantId].json".replace("[tenantId]", e)
            }
            ...
            getConfig() {
                return e = this, t = void 0, o = function* () {
                    ...
                    try {
                        let n;
                        if (this.productsConfig) n = JSON.parse(this.productsConfig); else {
                            const t = yield function (e, t = {}) {
                                return n = this, o = void 0, i = function* () {
                                    const n = 8e3, {timeout: o = n} = t, r = new AbortController,
                                        i = setTimeout((() => r.abort()), o),
                                        a = yield fetch(e, Object.assign(Object.assign({}, t), {signal: r.signal}));
                        ...
                        n ? (n.defaultProducts && (n.defaultProducts = this.overrideDefaultProducts(n)), t = Object.assign(Object.assign({}, t), n)) : console.warn("[PORTFÓLIO][BARRA] Configuração do produto vazia!")
                    } catch (e) {
                        "AbortError" === e.name ? console.error("[PORTFÓLIO][BARRA] Tempo limite da request excedido") : console.error("[PORTFÓLIO][BARRA] Erro na request do JSON do produto: ", e)
                    }
                    return t
        ...
        class m {
            constructor(e) {
                this.props = e, this.handleClick = e => {
                    this.state.userInfo ? (function (e, t) {
                        const n = e.shadowRoot.querySelector(".button-login"),
                            o = n.querySelector(".button-login-name");
                        n.ariaLabel = "Área do usuário", o.innerHTML = t.name, a(e.shadowRoot, t)
                    }(this.props.root, this.state.userInfo), this.dropdownLogin.isOpen() ? this.dropdownLogin.close() : (this.dropdownLogin.open(), e.stopPropagation())) : f.login(), C.getInstance().send("barra globo", "Click para entrar", "Login Iniciado"), R.getInstance().event("barra globo", "Login Iniciado", !0, "click")
                }, this.state = {userInfo: null}, this.dropdownLogin = new I({root: this.props.root, onLogout: i})
            }

            createElement() {
                const e = this.createButton(!0), t = this.dropdownLogin.createElement(),
                    n = this.createSkeletonCircle(), o = this.createSkeletonBox();
                return e.insertAdjacentElement("afterbegin", o), e.insertAdjacentElement("afterbegin", n), e.appendChild(t), e.style.pointerEvents = "none", e
            }
                ...
                return t = this, n = void 0, r = function* () {
                    yield function (e, t) {
                        ...
                        return new Promise((o => {
                            ...
                            r.observe(t ? document.body : t, {childList: !0, subtree: !0})
                        }))
                    }(".base-container .container-right", this.props.root.shadowRoot);
                    const t = this.props.root.shadowRoot.querySelector(".base-container .container-right");
                    if (t) {
                        const n = this.props.root.shadowRoot.querySelector(".base-container .button-login");
                        this.state = Object.assign(Object.assign({}, this.state), {userInfo: e});
                        const o = this.createButton(!1), r = this.dropdownLogin.createElement();
                        o.appendChild(r), a(o, this.state.userInfo || y), n.remove(), t.appendChild(o)
                    }
        ...
        class I {
            constructor(e) {
                this.props = e, this.handleClickMyAccount = e => {
                    C.getInstance().send("barra globo", "Click Minha conta", "https://minhaconta.globo.com"), R.getInstance().event("barra globo - Entrar Minha Conta", "https://minhaconta.globo.com", !0, "click"), e.stopPropagation()
                }, this.handleClickLogout = e => {
                    this.props.root.shadowRoot.querySelector(".base-container").classList.remove("user-logged"), this.props.onLogout && this.props.onLogout(this.props.root), this.close(), C.getInstance().send("barra globo", "Click Usuário", "Sair"), R.getInstance().event("barra globo", "Logout", !0, "click"), e.stopPropagation(), f.logout()
            ...
            createElement() {
                const e = document.createElement("ul"), t = this.createListItemMyAccount(),
                    n = this.createListItemLogout();
                return e.className = "container-dropdown-login", e.appendChild(t), e.appendChild(n), document.addEventListener("click", this.handleClickOutsideDropdown), e
            }

            createListItemMyAccount() {
                const e = new c({attributes: {class: "list-item-my-account"}}), t = new s({
                    name: "Minha conta",
                    url: "https://minhaconta.globo.com/",
                    onClick: this.handleClickMyAccount,
                    attributes: {ariaLabel: "Minha conta Globo", tabIndex: 0}
                }), n = e.createElement(), o = t.createElement();
                return n.appendChild(o), n
            }

            createListItemLogout() {
                const e = new c({attributes: {class: "list-item-logout"}}), t = new l({
                    name: "Sair",
            ...
            isOpen() {
                return this.props.root.shadowRoot.querySelector(".container-dropdown-login").className.includes("open")
            }

            open() {
                this.isOpen() || (this.props.root.shadowRoot.querySelector(".container-dropdown-login").classList.add("open"), C.getInstance().send("barra globo", "Click Usuário", "Abrir"), R.getInstance().event("barra globo", "Click Usuário - Abrir", !0, "click"))
            }

            close() {
                this.props.root.shadowRoot.querySelector(".container-dropdown-login").classList.remove("open"), C.getInstance().send("barra globo", "Click Usuário", "Fechar"), R.getInstance().event("barra globo", "Click Usuário - Fechar", !0, "click")
            }
        }
        ...
        class E {
            ...
            createElement() {
                const e = this.createListItem(), t = this.createLinkLogo();
                return e.appendChild(t), e
            }

            createListItem() {
                return new c({attributes: {class: "list-item-product"}}).createElement()
            }

            createLinkLogo() {
                const {name: e, url: t, ariaLabel: n, accessKey: o, customStyle: r, logo: i} = this.props.productConfig;
                return new p({
                    name: e,
                    url: t,
                    customStyle: r,
                    logo: {useImage: i.useImage, image: i.image, customStyle: null == i ? void 0 : i.customStyle},
        ...
        class w {
            ...
            createTemplate() {
                return e = this, t = void 0, o = function* () {
                    ...
                    this.setWindowBarraConfig({metricsConfig: this.barraConfig.metricsConfig});
                    const t = this.createBase();
                    return e.content.appendChild(this.mountStyle()), e.content.appendChild(t), e
                }, new ((n = void 0) || (n = Promise))((function (r, i) {
                    function a(e) {
                        try {
                            c(o.next(e))
            ...
            setWindowBarraConfig(e) {
                window.glb.barra.novaBarraConfig = Object.assign(Object.assign({}, window.glb.barra.novaBarraConfig), e)
            }

            createBase() {
                return new g({barraConfig: this.barraConfig, root: this.root}).createElement()
            }
        ...
        class C {
            ...
            initHorizon() {
                const t = new e;
                this._horizon = new _.HorizonClient(t.get("SITE_ID"), t.get("MOBILE_GROUP"), "barra-globo")
            }
            ...
            send(e, t, n) {
                var o, r, i;
                if (!(null === (i = null === (r = null === (o = null === window || void 0 === window ? void 0 : window.glb) || void 0 === o ? void 0 : o.barra) || void 0 === r ? void 0 : r.novaBarraConfig) || void 0 === i ? void 0 : i.metricsConfig.horizon.enabled)) return;
                const a = {
                    id: "common-event",
                    version: "0.1",
                    contentType: "common",
        ...
        class R {
            getLib() {
                return S(this, void 0, void 0, (function* () {
                    var e;
                    return this._lib || (this._lib = yield(e = "libAnalytics", new Promise((t => {
                        let n = 0;
                        const o = () => n >= 500 ? (console.warn("[PORTFÓLIO][BARRA] libAnalytics não encontrada"), void t(null)) : window[e] && 0 !== Object.keys(window[e]).length ? void t(window[e]) : (n += 10, void setTimeout(o, 10));
                        o()
                    })))), this._lib
                }))
            }
            ...
            event(e, t, n, o) {
                var r, i, a;
                return S(this, void 0, void 0, (function* () {
                    if (!(null === (a = null === (i = null === (r = null === window || void 0 === window ? void 0 : window.glb) || void 0 === r ? void 0 : r.barra) || void 0 === i ? void 0 : i.novaBarraConfig) || void 0 === a ? void 0 : a.metricsConfig.ga4.enabled)) return;
                    const s = {
                        data: [{key: e, value: t, persist: n}],
                        events: [{type: "ga4", method: "gtm", disableCommonEvent: !1, eventName: o, eventParams: [e]}]
                    }, c = yield this.getLib();
        ...
        const A = function () {
            ...
            window._comscore = window._comscore || [], _comscore.push({
                c1: "2",
                c2: "6035227",
                options: {enableFirstPartyCookie: !0, bypassUserConsentRequirementFor1PCookie: !0}
            }), e = "https://sb.scorecardresearch.com/cs/6035227/beacon.js", (o = document.createElement("script")).type = "text/javascript", o.async = !0, o.id = "jsonpGeneratedId-".concat(window.glb.barra.scriptHeaderId.toString()), o.src = e, window.glb.barra.scriptHeaderId++, function (e, t, n) {
                var o = document.getElementsByTagName("head")[0];
                t && (n && "onreadystatechange" in e && (e.htmlFor = e.id, e.event = "onclick"), e.onreadystatechange = function () {
                ...
                }, e.readyState || (e.onload = e.onreadystatechange, n && (e.onerror = e.onload))), o.appendChild(e)
            }(o, t, n)
        };

        class O extends HTMLElement {
            constructor() {
                super(), this.tenantId = this.tenantId, this.productsConfig = this.productsConfig
            }

            connectedCallback() {
                return e = this, t = void 0, o = function* () {
                    const e = document.querySelector("#glbbarrawidget");
                    if (window.glb = window.glb || {}, window.glb.barra = window.glb.barra || {}, window.glb.barra.scriptHeaderId = 0, !e.contains(this)) {
                        const t = new v(this.tenantId, this.productsConfig), n = new w(t, this);
                        this.attachShadow({mode: "open"});
                        const o = yield n.createTemplate();
                        this.shadowRoot.appendChild(o.content), e.appendChild(this), this.onLoaded(n.getBarraConfig())
                    }
                }, new ((n = void 0) || (n = Promise))((function (r, i) {
                    function a(e) {
                        try {
            ...
            onLoaded(e) {
                this.hideOverlayAddictionalProducts(), e.incluirComScore && A(), this.removeJsonAfterRender()
            }

            hideOverlayAddictionalProducts() {
                const e = this.shadowRoot.querySelector(".container-list-item");
                e.scrollWidth <= screen.width && e.style.setProperty("--overlay-display", "none")
            }

            removeJsonAfterRender() {
                const e = document.querySelector("nova-barra-globocom");
                (null == e ? void 0 : e.getAttribute("products-config")) && (null == e || e.removeAttribute("products-config"))
            }

            set tenantId(e) {
                e ? this.setAttribute("tenant-id", e) : this.setAttribute("tenant-id", "default")
            }
            ...
            set productsConfig(e) {
                e ? this.setAttribute("products-config", e) : this.setAttribute("products-config", "")
            }
